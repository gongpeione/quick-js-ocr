...
const arrayMethods = Object.create(arrayProto);['push', 'pop', 'shift', 'unshift', 'splice', 'sort', 'reverse'].forEach(function (method) {
...
function add$1(event, handler, once$$1, capture, passive) {
  ...
  target$1.addEventListener(event, handler, supportsPassive ? { capture, passive } : capture);
}
...
},{"../src/jsocr":7,"vue/dist/vue.esm.browser":9}],0:[function(require,module,exports) {
var global = (1,eval)('this');
...
if (!module.bundle.parent) {
  var ws = new WebSocket('ws://localhost:52511/');
  ws.onmessage = (e) => {
